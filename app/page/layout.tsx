...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "گنجینه‌ای از شعر کلاسیک و معاصر فارسی، دیوان حافظ، شعر نو، و سخنان بزرگان. با موتور اختصاصی تیغ. رایگان، متن‌باز، بدون ثبت‌نام و بدون کلید API.",
    url: "/",
    type: "website",
  },
  twitter: {
    title: "API اشعار فارسی — Persian Quotes API",
    description: "شعر کلاسیک و معاصر، دیوان حافظ و سخنان بزرگان با موتور تیغ. رایگان و متن‌باز.",
  },
}
