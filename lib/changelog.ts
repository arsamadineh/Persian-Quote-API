...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    changes: [
      {
        type: "fixed",
        description: "جستجو با پارامتر poet در اندپوینت /api/quotes اکنون مجموعه شعر نو را نیز جستجو می‌کند؛ شاعران شعر نو دیگر نتیجه خالی برنمی‌گرداندند.",
      },
      {
        type: "fixed",
        description: "اندپوینت embed تنها دو شاعر شعر نو را پشتیبانی می‌کرد؛ اکنون تمام شاعران از مخزن یکپارچه خوانده می‌شوند.",
      },
      {
        type: "fixed",
        description: "متن شعر نو در ویجت embed از فیلد خام JSON خوانده می‌شد؛ اکنون از نسخه نرمال‌شده مخزن استفاده می‌شود.",
      },
      {
        type: "fixed",
        description: "برش متن شعر نو در ویجت embed دیگر وسط کلمه نمی‌افتد؛ کوتاه‌سازی در مرز کلمه انجام می‌شود.",
      },
      {
        type: "fixed",
        description: "ستاره‌های ناخواسته ناشی از علامت‌های تفکیک در اشعار نو پاک‌سازی و با خط جدید جایگزین شدند.",
      },
      {
        type: "fixed",
        description: "طراحی و خوانایی صفحه ساختار در حالت تم روشن با استفاده از متغیرهای یکپارچه پوسته اصلاح شد.",
      },
      {
        type: "fixed",
        description: "هنگام یافت‌نشدن شاعر در embed، دیگر شعر اشتباه نمایش داده نمی‌شود؛ پاسخ ۴۰۴ با پیام مناسب برگردانده می‌شود.",
      },
      {
        type: "changed",
        description: "مسیرهای ثابت API پیش از مسیر پویا [poet] ثبت می‌شوند تا ترتیب خواندن کد منطقی‌تر باشد.",
      },
    ],
  },
  {
